 ...
 * NOTE!    you can user it free, but keep the copyright please
 * IMPORTANT:you must include this script file inner html body elment 
 */
 

function fPopCalendar(popCtrl, dateCtrl){
	new Calendar(2006,(new Date()).getFullYear()).show(popCtrl);
}
...
Calendar.language = {
	...
	"date2StringPattern" : ["yyyy-MM-dd", "MM-dd-yyyy", "dd-MM-yyyy", "yyyy-MM-dd"],
	"string2DatePattern" : ["ymd","mdy", "dmy", "ymd"]
};
...
String.prototype.toDate = function(delimiter, pattern) {
	...
	var m = parseInt(a[pattern.indexOf("m")]) - 1;
	var d = parseInt(a[pattern.indexOf("d")]);
	if(isNaN(d)) d = 1;
	return new Date(y, m, d);
};

document.writeln('<div id="__calendarPanel" style="position:absolute;visibility:hidden;z-index:10000;background-color:#FFFFFF;border:1px solid #666666;width:200px;height:216px;">');
